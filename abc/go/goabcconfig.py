...
if __name__ == "__main__" :
    ...
    probList += [(f"abc230",f"abc230_{x}") for x in ("A","B","C","D","E","F","G")]
    ...
    probList += [(f"abc235",f"abc235_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc236",f"abc236_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc237",f"abc237_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc238",f"abc238_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc239",f"abc239_{x}") for x in ("A","B","C","D","E","F","G","Ex")]
    probList += [(f"abc240",f"abc240_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc241",f"abc241_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc242",f"abc242_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc243",f"abc243_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc244",f"abc244_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc245",f"abc245_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc246",f"abc246_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc247",f"abc247_{x}") for x in ("A","B","C","D","E","F","G","Ex")]
    probList += [(f"abc248",f"abc248_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc249",f"abc249_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc250",f"abc250_{x}") for x in ("A","B","C","D","E","F","G","Ex")]
    probList += [(f"abc251",f"abc251_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc252",f"abc252_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc253",f"abc253_{x}") for x in ("A","B","C","D","E","F","G")]
    probList += [(f"abc254",f"abc254_{x}") for x in ("A","B","C","D","E","F","G","Ex")]
    probList += [(f"abc255",f"abc255_{x}") for x in ("A","B","C","D","E","F","G","Ex")]
