...
if __name__ == "__main__" :
    ...
    ##probList += [(f"abc233",f"abc233_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc234",f"abc234_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc235",f"abc235_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc236",f"abc236_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc237",f"abc237_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc238",f"abc238_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc239",f"abc239_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc240",f"abc240_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc241",f"abc241_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc242",f"abc242_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc243",f"abc243_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc244",f"abc244_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc245",f"abc245_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc246",f"abc246_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc247",f"abc247_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc248",f"abc248_{x}") for x in ("A","B","C","D","E","F","G","H")]
    ##probList += [(f"abc249",f"abc249_{x}") for x in ("A","B","C","D","E","F","G","H")]
